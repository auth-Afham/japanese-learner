...
const phrases = {
    ...
    // --- GRAMMAR EXAMPLES ---
    "Particles (Examples)": [
    { jp: '犬が走る。', romaji: 'Inu ga hashiru.', en: 'The dog runs.' },
    { jp: '花がきれいです。', romaji: 'Hana ga kirei desu.', en: 'The flowers are beautiful.' },
    { jp: '私は学生です。', romaji: 'Watashi wa gakusei desu.', en: 'As for me, I am a student.' },
    { jp: '猫が魚を食べる。', romaji: 'Neko ga sakana o taberu.', en: 'The cat eats the fish.' },
    { jp: '毎日、公園を散歩します。', romaji: 'Mainichi, kouen o sanpo shimasu.', en: 'I walk in the park every day.' },
    { jp: '学校に行く。', romaji: 'Gakkou ni iku.', en: 'Go to school.' },
    { jp: '友達に手紙を書きました。', romaji: 'Tomodachi ni tegami o kakimashita.', en: 'I wrote a letter to my friend.' },
    { jp: '友達にあげる。', romaji: 'Tomodachi ni ageru.', en: 'Give to a friend.' },
    { jp: 'バスで行く。', romaji: 'Basu de iku.', en: 'Go by bus.' },
    { jp: 'レストランで食べる。', romaji: 'Resutoran de taberu.', en: 'Eat at a restaurant.' },
    { jp: '電車で駅に行きます。', romaji: 'Densha de eki ni ikimasu.', en: 'I go to the station by train.' },
    { jp: '私の本。', romaji: 'Watashi no hon.', en: 'My book.' },
    { jp: '私も行く。', romaji: 'Watashi mo iku.', en: 'I go too.' },
    { jp: '何ですか？', romaji: 'Nani desu ka?', en: 'What is it?' },
    { jp: '東京へ行く。', romaji: 'Tokyo e iku.', en: 'Go towards Tokyo.' },
],

"Compound Particles (Examples)": [
    { jp: '公園では楽しいです。', romaji: 'Kouen de wa tanoshii desu.', en: 'As for the park, it\'s fun.' },
    { jp: '学校では静かにします。', romaji: 'Gakkou de wa shizuka ni shimasu.', en: 'At school, I keep quiet.' },
    { jp: '雨が降っているのに、外に行きます。', romaji: 'Ame ga futte iru no ni, soto ni ikimasu.', en: 'Although it\'s raining, I\'ll go outside.' },
    { jp: '疲れているのに、仕事に行きます。', romaji: 'Tsukarete iru no ni, shigoto ni ikimasu.', en: 'Although I’m tired, I go to work.' },
    { jp: '速くなるように勉強します。', romaji: 'Hayaku naru yo ni benkyou shimasu.', en: 'I study so that I can become faster.' },
    { jp: '上手になるように練習します。', romaji: 'Jouzu ni naru yo ni renshuu shimasu.', en: 'I practice to become skilled.' },
    { jp: 'あなたのことについて話します。', romaji: 'Anata no koto ni tsuite hanashimasu.', en: 'I\'ll talk about you.' },
    { jp: '興味がありますね。', romaji: 'Kyōmi ga arimasu ne.', en: 'You have interest, don\'t you?' },
    { jp: '食べたいからです。', romaji: 'Tabetai kara desu.', en: 'It\'s because I want to eat.' },
    { jp: '愛とは何ですか？', romaji: 'Ai to wa nan desu ka?', en: 'What is love?' },
    { jp: 'この方がいいです。', romaji: 'Kono no ho ga ii desu.', en: 'This one is better.' },
    { jp: '食べている。', romaji: 'Tabete iru.', en: 'Is eating.' },
],

"Transition Words/Phrases (Examples)": [
    { jp: '食べるそして飲む。', romaji: 'Taberu soshite nomu.', en: 'Eat and drink.' },
    { jp: '映画を見て、そして寝ました。', romaji: 'Eiga o mite, soshite nemashita.', en: 'I watched a movie and then slept.' },
    { jp: 'おいしいさらに安い。', romaji: 'Oishii sara ni yasui.', en: 'Delicious, furthermore cheap.' },
    { jp: '行きたいでも忙しい。', romaji: 'Ikitai demo isogashii.', en: 'I want to go but I\'m busy.' },
    { jp: '忙しいだから、会えません。', romaji: 'Isogashii dakara, aemasen.', en: 'I’m busy, so I can’t meet.' },
    { jp: '雨が降ったしかし楽しかった。', romaji: 'Ame ga futta shikashi tanoshikatta.', en: 'It rained, however it was fun.' },
    { jp: '難しい、しかし挑戦します。', romaji: 'Muzukashii, shikashi chousen shimasu.', en: 'It’s difficult, but I’ll try.' },
    { jp: '寒いだから家にいる。', romaji: 'Samui dakara ie ni iru.', en: 'It\'s cold, so I\'ll stay home.' },
    { jp: '話すそれでわかる。', romaji: 'Hanasu sore de wakaru.', en: 'Talk, then understand.' },
    { jp: '食べ物たとえば寿司。', romaji: 'Tabemono tatoeba sushi.', en: 'Food, for example sushi.' },
    { jp: '難しいそれでも頑張る。', romaji: 'Muzukashii sore demo ganbaru.', en: 'It\'s difficult, nevertheless I\'ll try.' },
    { jp: '茶あるいはコーヒー。', romaji: 'Cha aruiwa kohii.', en: 'Tea or coffee.' },
],

"Auxiliary Verbs (Examples)": [
    { jp: '勉強をします。', romaji: 'Benkyou o shimasu.', en: 'I study.' },
    { jp: '音楽を聴きます。', romaji: 'Ongaku o kikimasu.', en: 'I listen to music.' },
    { jp: '宿題をしました。', romaji: 'Shukudai o shimashita.', en: 'I did homework.' },
    { jp: '会社で親に仕事をされました。', romaji: 'Kaisha de oya ni shigoto o saremashita.', en: 'I was made to work by my parents at the company.' },
    { jp: '先生に質問をされました。', romaji: 'Sensei ni shitsumon o saremashita.', en: 'I was asked a question by the teacher.' },
    { jp: '話をされて、疲れました。', romaji: 'Hanashi o sarete, tsukaremashita.', en: 'I was told a story and got tired.' },
    { jp: '子供に勉強をされます。', romaji: 'Kodomo ni benkyou o saremasu.', en: 'The child is taught to study.' },
    ...
    { jp: '昨日、お金がありました。', romaji: 'Kinou, okane ga arimashita.', en: 'There was money yesterday.' },
    { jp: 'あなたことを知りたいです。', romaji: 'Anata no koto o shiritai desu.', en: 'I want to know about you.' },
],
};
